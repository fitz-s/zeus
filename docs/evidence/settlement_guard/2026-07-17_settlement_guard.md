# Settlement Guard Report — 2026-07-17T09:15:00.079417+00:00
...
|---|---|---|---|---|---|---|
| 7d | 59 | 33 | 55.9% | [42.4%, 68.8%] | $-57.65 | no |
| 30d | 127 | 66 | 52.0% | [42.9%, 60.9%] | $-146.04 | no |

## Overall (all settled traded fills)

- settled trades: **156** (wins 87, losses 69)
- win-rate: **55.8%** (raw 55.8%), 95% CI [47.6%, 63.7%]
- after-cost PnL: **$-137.32** on $1205.14 cost basis (ROI -11.4%)
- calibration: mean entry q=0.850 vs realized win-rate=55.8%; Brier=0.3364, log-loss=1.5528 (n_with_q=97)

## By direction

| direction | n | wins | win-rate | 95% CI | after-cost PnL |
|---|---|---|---|---|---|
| buy_no | 141 | 85 | 60.3% | [51.7%, 68.4%] | $-174.71 |
...
| Seoul|high | 8 | 6 | n/a | [34.9%, 96.8%] | $+14.84 |
