# Settlement Guard Report — 2026-07-19T09:15:00.087465+00:00
...
|---|---|---|---|---|---|---|
| 7d | 94 | 67 | 71.3% | [61.0%, 80.1%] | $+137.30 | YES |
| 30d | 156 | 99 | 63.5% | [55.4%, 71.0%] | $+71.02 | YES |

## Overall (all settled traded fills)

- settled trades: **191** (wins 121, losses 70)
- win-rate: **63.4%** (raw 63.4%), 95% CI [56.1%, 70.2%]
- after-cost PnL: **$+57.62** on $1682.62 cost basis (ROI 3.4%)
- calibration: mean entry q=0.885 vs realized win-rate=63.4%; Brier=0.2526, log-loss=1.1566 (n_with_q=132)

## By direction

| direction | n | wins | win-rate | 95% CI | after-cost PnL |
|---|---|---|---|---|---|
| buy_no | 176 | 119 | 67.6% | [60.2%, 74.5%] | $+20.23 |
