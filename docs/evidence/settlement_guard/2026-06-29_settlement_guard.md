# Settlement Guard Report — 2026-06-29T09:15:00.243384+00:00
...
|---|---|---|---|---|---|---|
| 7d | 15 | 6 | n/a | [16.3%, 67.7%] | $-4.09 | — |
| 30d | 72 | 41 | 56.9% | [44.7%, 68.6%] | $-36.94 | no |

## Overall (all settled traded fills)

- settled trades: **72** (wins 41, losses 31)
- win-rate: **56.9%** (raw 56.9%), 95% CI [44.7%, 68.6%]
- after-cost PnL: **$-36.94** on $488.76 cost basis (ROI -7.6%)
- calibration: mean entry q=0.648 vs realized win-rate=56.9%; Brier=0.2311, log-loss=0.6512 (n_with_q=14)
