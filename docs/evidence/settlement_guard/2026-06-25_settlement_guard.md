# Settlement Guard Report — 2026-06-25T09:15:00.142610+00:00
...
|---|---|---|---|---|---|---|
| 7d | 28 | 14 | 50.0% | [30.6%, 69.4%] | $-26.48 | no |
| 30d | 60 | 36 | 60.0% | [46.5%, 72.4%] | $-31.76 | no |

## Overall (all settled traded fills)

- settled trades: **60** (wins 36, losses 24)
- win-rate: **60.0%** (raw 60.0%), 95% CI [46.5%, 72.4%]
- after-cost PnL: **$-31.76** on $395.44 cost basis (ROI -8.0%)
- calibration: mean entry q=0.483 vs realized win-rate=60.0%; Brier=0.0232, log-loss=0.1642 (n_with_q=2)

## By direction

| direction | n | wins | win-rate | 95% CI | after-cost PnL |
|---|---|---|---|---|---|
| buy_no | 53 | 35 | 66.0% | [51.7%, 78.5%] | $-32.13 |
