...
| `src/state/db.py:11141` | position_current | chain_avg_price, chain_cost_basis_usd, chain_shares, cost_basis_usd, entry_price, shares, size_usd | `query_position_current_status_view` |
| `src/state/db.py:11589` | position_current | cost_basis_usd, entry_price, shares, size_usd | `query_portfolio_loader_view` |
