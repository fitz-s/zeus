...
| File | Purpose |
|------|---------|
| `known_gaps.md` | Active known-gap worklist; OPEN/PARTIALLY FIXED/STALE-UNVERIFIED/residual MITIGATED gaps |
...
- Active known gaps live here, not in `docs/operations/`; `docs/operations/known_gaps.md` is a compatibility pointer only.
