...
|---|---|
| **A**: "W2 cite-resolver regex fails on multi-line cite blocks" | **B**: extend regex to also match `<!-- cite_block: ... -->` fenced form; add fixture in `tests/test_doc_citation_lint.py::test_multiline_block`. |
