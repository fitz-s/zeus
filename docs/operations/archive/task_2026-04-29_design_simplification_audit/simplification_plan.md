...
- Phase 1K live decision snapshot causality gate is repaired for the scoped
  ...
  timing, or entry-primary authority is missing. Accepted decisions persist
  those fields in `epistemic_context_json.forecast_context`. This does not
  choose the canonical live snapshot table, activate TIGGE/direct ECMWF, promote
