...
`config/settings.json` contains `edli_v1.enabled=true`, `reactor_mode=live`,
event writer/forecast/Day0/market-channel/no-trade-regret/reports enabled,
and both `stale_book_directional_trading_enabled=false` and
