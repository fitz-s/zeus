...
| `task_2026-04-30_source_auto_conversion/` | packet evidence | Source-contract auto-conversion runtime packet for deterministic cron controller, source quarantine, scoped same-provider WU apply, date scopes, receipt/evidence writing, Discord reporting, and gated quarantine release; default is dry-run, apply requires explicit evidence-gated controller flags |
