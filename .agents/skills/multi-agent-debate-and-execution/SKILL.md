...
- Use `~/.Codex/teams/<team-name>/config.json` (or platform equivalent)
...
- `.Codex/skills/zeus-methodology-bootstrap/SKILL.md` — auto-load on debate-class tasks
...
### Related skills
- `.Codex/skills/zeus-phase-discipline/SKILL.md` — Mode C per-batch discipline
- `.Codex/skills/zeus-task-boot-*/SKILL.md` — task-specific boot profiles
