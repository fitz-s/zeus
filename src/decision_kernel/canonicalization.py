...
_QKERNEL_CURRENT_STATE_IDENTITY_FIELDS: tuple[str, ...] = (
    ...
    "global_cut_time_expected_value_telemetry_usd",
    "global_expected_value_telemetry_usd",
...
def qkernel_global_current_state_rejection_reason(
    ...
    *,
    ...
    cut_ev = numeric["global_cut_time_expected_value_telemetry_usd"]
    expected_value = numeric["global_expected_value_telemetry_usd"]
    ...
    if economics["global_expected_value_semantics"] != (
        "TELEMETRY_EXPECTATION_NOT_REALIZED_GAIN"
    ):
