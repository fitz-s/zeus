...
def get_calibrator(
    ...
    *,
    ...
    #
    # Count and fit one canonical population. A hidden fallback to an older
    # bin source would silently borrow another cluster's transform.
    if temperature_metric == "high":
        _fit_bin_source = CANONICAL_CALIBRATION_PAIR_BIN_SOURCE
...
def _fit_from_pairs(
    ...
    #
    # The caller threads the same canonical bin source into count and fit.
