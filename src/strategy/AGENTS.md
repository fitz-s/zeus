...
| `selection_family.py` | Family-wise hypothesis-selection substrate + Benjamini-Hochberg FDR control (`DEFAULT_FDR_ALPHA`, `apply_familywise_fdr`) | HIGH — false discovery prevention |
