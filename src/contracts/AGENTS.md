...
| `global_auction_receipt.py` | Immutable schema-22 row with schema-21 execution compatibility | HIGH — certificate/command/settlement attribution chain |
...
- A global winner is not actionable until its committed schema-22 row, logical receipt hash, execution binding, and exact persisted-summary hash are frozen into the actuation and certificate.
