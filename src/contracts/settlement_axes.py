...
instead of re-deriving WIN/LOSE-vs-YES/NO from the overloaded integer.

(2026-07-25: the former A10 RedemptionAccountingPhase axis over
settlement_commands.state was removed here -- on-chain redemption is decoupled
entirely from Zeus (Polymarket settles win/loss on our behalf), and the axis
