            ...
            for published_raw, value_raw, unit_raw, station_raw, channel, raw_report, fetched_raw in channel_rows:
                ...
                try:
                    ...
                    if observed is None or observed.astimezone(tz).date() != day:
                        continue
                    # This remote branch has no generic raw-temperature parser.
                    # Its ledger value is already Celsius; only a precise T-group
                    # may supersede it for the physical report value.
                    parsed_temp = metar_t_group_temperature_c(raw_text)
