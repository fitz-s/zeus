...
# Open Data ships hourly steps; we want every 6h boundary up to 276h
# (inclusive) to cover the configured D+10 city-local calendar-day contract
# horizon across UTC-positive and UTC-negative cities. Steps must be multiples
# of 6 since mx2t6/mn2t6 are 6-hour aggregations.
STEP_HOURS = list(range(6, 282, 6))
