...
def _market_bins_to_celsius(
    ...
    *,
    ...
    for row in ordered:
        ...
        seen.add(label)
        lower_c = _temperature_to_c(row.get("range_low"), unit=settlement_unit)
        upper_c = _temperature_to_c(row.get("range_high"), unit=settlement_unit)
...
def build_replacement_forecast_materialization_seed(
    *,
    ...
    source_cycle_time = max(
        [
            _dt(baseline_coverage.get("source_cycle_time") or baseline_coverage.get("computed_at"), field_name="baseline_source_cycle_time"),
            aifs_manifest.source_cycle_time,
    ...
    seed = {
        ...
        "bins": _market_bins_to_celsius(market_bins, settlement_unit=settlement_unit),
