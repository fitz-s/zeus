...
SQLITE_CONNECT_ALLOWLIST: frozenset[str] = frozenset(
    {
        ...
        "scripts/audit_escalation_cross_rerest.py",      # read_only_ro_uri: opens zeus_trades.db via file:...?mode=ro uri; SELECT-only over venue_commands+venue_order_facts; calls imported _family_rest_state; never writes — GAP-4 escalation-cross re-rest fix auditability (2026-06-21)
