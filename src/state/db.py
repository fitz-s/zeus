...
CREATE TABLE IF NOT EXISTS position_events (
    ...
    -- IN(...) list (fixed 2026-07-13, LX-F) — tests/state/
    ...
    -- POSITION_IDENTITY_SUPERSEDED is the duplicate-position identity
    -- supersession FACT, emitted by position_duplicate_consolidator instead
    -- of synthesized merge economics.
