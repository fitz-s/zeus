...
| P1-E | P1 | Migrate learning loop to authoritative ledger + evaluated opportunity set | truth/learning lane | IN_PROGRESS | Slice 1 is landed: authoritative settlement readers are env-filtered. Consumer follow-ups now include operator/risk truth surfaces and deeper learning migration on top of those cleaner readers. |
