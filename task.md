...
| P0-D | P0 | Close runtime spine: pending/live fail-closed, Day0 terminal phase, durable transition/event emission | runtime lane | IN_PROGRESS | Slice 1 is landed: phantom-void / stale-Day0 freshness seams closed. Remaining P0-D work is Day0 exit authority, pending/live verification ownership, and durable `day0_window` lifecycle emission. |
