...
7. **Evidence-class mismatch**: live execution authority vs diagnostic, simulated, shadow, replay, or backtest evidence — can any non-live evidence authorize live orders, exits, settlement, reports, or learning? Does environment input remain inert rather than a selector? Per INV-29 (no live-bypass via alternate execution evidence).
