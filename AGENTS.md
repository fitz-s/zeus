...
- `docs/reference/zeus_math_spec.md` — probability chain formulas, calibration math (incl. empirical-Bayes ENS bias correction + predictive-error layer: `src/calibration/ens_bias_model.py`, `ens_error_model.py`)
