...
Usage:
    python scripts/memory_repair_apply.py [--audit-file <path>]
...
_BASE = Path.home() / ".claude/projects/-Users-leofitz--openclaw-workspace-venus-zeus"
MEMORY_DIR = _BASE / "memory"
ZEUS_ROOT  = Path.home() / ".openclaw/workspace-venus/zeus"
