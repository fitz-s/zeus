...
def _check_task_dir_sprawl_ceiling(topology: dict[str, Any]) -> list[TopologyIssue]:
    return _docs_checks().check_task_dir_sprawl_ceiling(sys.modules[__name__], topology)


def _check_new_packet_outside_current(topology: dict[str, Any]) -> list[TopologyIssue]:
