...
2. calibration_pairs: counts per bucket, recent accrual rate
3. platt_models: Brier insample, active count per bucket
4. ETL table freshness: diurnal, temp_persistence, asos_wu_offsets
