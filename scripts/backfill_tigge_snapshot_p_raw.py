...
USAGE:
    ...
    python scripts/backfill_tigge_snapshot_p_raw.py

    # Live write (requires --no-dry-run --force):
    python scripts/backfill_tigge_snapshot_p_raw.py --no-dry-run --force

    # Single city:
    python scripts/backfill_tigge_snapshot_p_raw.py --city Chicago
...
def backfill(
    ...
    *,
    ...
    for row in rows:
        ...
        assert_data_version_allowed(data_version, context="backfill_tigge_snapshot_p_raw")
...
def backfill_all(
    ...
    *,
    ...
    """
    per_metric: dict[str, BackfillStats] = {}
