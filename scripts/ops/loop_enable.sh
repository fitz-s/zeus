...
echo ""
echo "  sed -e \"s#ZEUS_REPO_PLACEHOLDER#\$(pwd)#g\" -e \"s#ZEUS_HOME_PLACEHOLDER#\$HOME#g\" \\"
echo "    '$LAUNCHD_DIR/com.zeus.loop-tick.plist' > ~/Library/LaunchAgents/com.zeus.loop-tick.plist"
