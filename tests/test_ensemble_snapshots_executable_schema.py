...
"""Executable ensemble_snapshots schema contract tests."""
...
def test_ensemble_snapshots_has_executable_source_columns() -> None:
    conn = _conn()
...
def test_ensemble_snapshots_has_executable_lookup_indexes() -> None:
    conn = _conn()
