...
# Authority basis:
#   docs/archive/2026-Q2/task_2026-05-17_post_karachi_remediation/F22_WRITER_LOCK_FIX.md
#   docs/archive/2026-Q2/task_2026-05-17_post_karachi_remediation/OPS_FORENSICS.md §F22
...
def test_defer_marker_within_window(script: Path | None) -> None:
    ...
    assert not overdue, (
        ...
        "      in docs/archive/2026-Q2/task_2026-05-17_post_karachi_remediation/F22_WRITER_LOCK_FIX.md\n"
