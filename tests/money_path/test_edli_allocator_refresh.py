...
def test_main_edli_cycle_wires_live_path_allocator_refresh_source():
    ...
    # The refresh moved inside a bounded-connection construct wrapper; the wiring
    # law is unchanged: allocator refresh precedes adapter construction, and the
    # configured check gates in between.
