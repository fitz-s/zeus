...
# History: re-authored 2026-06-07 to re-invert the post-f0368a188c "can flip when
#   flagged" contamination back to the original antibody: flags alone (no evidence)
#   can never grant direction-flip authority.
...
def test_replacement_policy_cannot_flip_direction_without_evidence_even_when_flagged() -> None:
