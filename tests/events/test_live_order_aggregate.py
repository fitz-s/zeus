    ...
    economics.update(
        {
            ...
            "global_token_id": "token-yes" if side == "YES" else "token-no",
            "global_family_key": "family-current-1",
            "global_probability_witness_identity": "probability-witness-current-1",
            "global_probability_authority": "current_evidence_q",
            "global_posterior_id": "posterior-current-1",
            ...
            "edge_expected": 0.30,
            "global_expected_delta_log_wealth": 0.0029850437550215814,
            "global_expected_ev_usd": 0.30,
            "global_expected_capital_efficiency": 0.007462609387553953,
            "global_ruin_probability_reduction": 0.0,
            "global_terminal_ruin_probability_reduction": 0.0,
            "global_proposal_expected_delta_log_wealth": 0.0029850437550215814,
            "global_proposal_expected_ev_usd": 0.30,
            "global_proposal_expected_log_growth_per_hour": 0.0029850437550215814,
            "global_proposal_expected_capital_efficiency": 0.007462609387553953,
            ...
            "global_cut_time_win_probability_mean": 0.70,
            "global_cut_time_loss_probability_mean": 0.30,
            "global_terminal_win_probability_mean": 0.70,
            "global_terminal_loss_probability_mean": 0.30,
            ...
            "global_cut_time_expected_value_usd": 0.30,
            "global_expected_value_usd": 0.30,
...
def test_pre_submit_mean_winner_binds_action_probability_through_all_verifiers():
    ...
    economics = {
        ...
        "global_selection_revision": CURRENT_GLOBAL_CAPITAL_SELECTION_REVISION,
        "global_condition_id": "condition-1",
        "global_token_id": "token-yes",
        "global_family_key": "family-mean",
        "global_probability_witness_identity": "probability-witness-mean",
        "global_probability_authority": "current_evidence_q",
        "global_posterior_id": "posterior-mean",
